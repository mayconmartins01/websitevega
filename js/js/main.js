...
const textElement = document.querySelector(
  ".wrapper-text-protection .text-base"
);
...
function initializeSlider() {
  sliders.forEach((slider, index) => {
    ...
    const title =
      slider.querySelector(".text-xs.semibold") ||
      slider.querySelector("#title-" + slider.id.split("-")[1]);
...
function fadeOutCurrentSlide() {
  const currentSlider = sliders[currentSlideIndex];
  const title =
    currentSlider.querySelector(".text-xs.semibold") ||
    currentSlider.querySelector("#title-" + currentSlider.id.split("-")[1]);
...
function fadeInNewSlide() {
  ...
  const title =
    newSlider.querySelector(".text-xs.semibold") ||
    newSlider.querySelector("#title-" + newSlider.id.split("-")[1]);
...
(function () {
  ...
  const solutionsData = [
    {
      ...
      title: "TELECOM",
      headerText:
        "Prevenção avançada contra roubos e furtos para equipamentos de telecomunicações",
      contentTitle: "",
      contentDesc:
    ...
    },
    {
      ...
      highlight2:
        "Controle de manutenções preventivas, reduzindo paradas inesperadas.",
    ...
    },
    {
      ...
      contentDesc: "",
      highlight1:
        "Alertas personalizados de acordo com a necessidade de sua empresa.",
      highlight2:
        "Videomonitoramento (Vega View) para mais segurança e visibilidade.",
    ...
    },
    {
      ...
      highlight3:
        "Ideal para equipamentos de alto valor ou com alto risco de furto.",
    ...
    },
    {
      ...
      title: "CARGAS",
      headerText:
        "Monitoramento inteligente que garante a segurança total de suas cargas",
      contentTitle:
      ...
      highlight2:
        "Alertas de movimentação não autorizada ou situações de risco.",
    ...
    },
    {
      ...
      title: "LINHA AMARELA",
      headerText:
        "Gestão avançada para máquinas pesadas e equipamentos de construção",
      contentTitle:
      ...
      highlight4:
        "Aumento da produtividade com otimização do uso dos equipamentos.",
    },
    {
      id: "slt-vv",
      divId: "div-slt-vv",
      ...
      title: "VEGA VIEW",
      headerText:
        "Monitore, proteja e conquiste mais resultados com o poder da videotelemetria avançada",
      contentTitle:
      ...
      highlight2:
        "Identificação precisa de distrações, fadiga e comportamentos arriscados.",
    ...
    },
    {
      ...
      highlight3:
        "Crie alertas personalizados de velocidade, perímetros e muito mais.",
  ...
  const solutionsContentTitleElement =
    document.getElementById("slt-content-title");
  const solutionsButtonContainer = document.getElementById(
    "slt-button-container"
  );
  const solutionsContentDescElement =
    document.getElementById("slt-content-desc");
  ...
  function updateSolutionsContent(categoryId) {
    ...
    if (selectedData.buttonText && selectedData.buttonLink) {
      const btnClass = selectedData.buttonClass
        ? selectedData.buttonClass
        : ".btn--solutions";
